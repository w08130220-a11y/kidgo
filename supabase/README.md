...
6. 再貼 `0005_has_photo_column.sql` → Run (has_photo generated column 給排序用)
7. 再貼 `0006_feedback.sql` → Run (用戶反饋表)
8. 成功後 Tables 應該看得到 pois / profiles / itineraries / likes / comments / user_points / point_events / bookmarks / feedback
