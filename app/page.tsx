          ...
          {featuredItineraries.map((it) => {
            ...
            return (
              <Link
                ...
                className="group flex w-[88vw] max-w-[440px] shrink-0 snap-start flex-col gap-3 rounded-2xl border border-stone-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md sm:w-auto sm:max-w-none sm:shrink"
              >
